...
const getTeacherProfile = asyncHandler(async (req, res) => {
	const teacher = await Teacher.findById(req.params.id).populate('admin', 'empId fullName');
...
export { authTeacher, registerTeacher, getTeachers, getTeacherProfile, getTeacherDetails, deletedTeacher };
